...
export default class Tipocontrato extends Component {
    constructor(props) {
        ...
        onSubmit(e) {
            ...
            axios.post('http://localhost:4000/api/nuevo-tipocontrato', nuevotipocontrato)
                    ...
                    <div class="row g-4" >
                        <div class="col-sm-3">
                            <input type="text"
                                ...
                                value={this.state.codtipocontrato}
                                onChange={this.onChangecodtipocontrato}
                            />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-4">
                        <div class="col-sm-3">
                            <input
                                ...
                                value={this.state.nombretipocontrato}
                                onChange={this.onChangedesctipocontrato}
                            />
                        </div>
                    </div>
                </div>
