...
export default class Tipodevolucion extends Component {
    constructor(props) {
        ...
        onSubmit(e) {
            ...
            axios.post('http://localhost:4000/api/nuevo-coddev', nuevotipodevolucion)
                    ...
                    <div class="row g-4" >
                        <div class="col-sm-3">
                            <input type="text"
                                ...
                                value={this.state.coddevolucion}
                                onChange={this.onChangecoddevolucion}
                            />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-4">
                        <div class="col-sm-3">
                            <input
                                ...
                                value={this.state.nombredevoluciondevolucion}
                                onChange={this.onChangenombredevolucion}
                            />
                        </div>
                    </div>
                </div>
