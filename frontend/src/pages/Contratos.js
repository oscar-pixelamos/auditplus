...
export default class contratos extends Component {
    constructor(props) {
        ...
        onSubmit(e) {
            ...
            axios.post('http://localhost:4000/api/nuevo-contrato', nuevocontrato)
                  ...
                  <div>
                    <div>
                      <input
                        ...
                        value={this.state.codcontratos}
                        onChange={this.onChangecodcontratos}
                      />
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    <div>
                      <input
                        type="text"
                        className="form-control my-3"
                        value={this.state.valcontratos}
                        onChange={this.onChangevalcontratos}
                      />
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    <div>
                      <input
                        ...
                        value={this.state.fechinicontratos}
                        onChange={this.onChangefechinicontratos}
                      />
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    <div>
                      <input
                        type="date"
                        className="form-control"
                        value={this.state.fechfincontratos}
                        onChange={this.onChangefechfincontratos}
                      />
                    </div>
                  </div>
                </div>
